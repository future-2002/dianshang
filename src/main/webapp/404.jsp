...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: url("./imgs/blueprint.png") repeat 0 0;
        }
        ...
        div.da-error-wrapper .da-error-code {
            ...
            font-size: 32px;
            text-align: center;
            background: url("../imgs/error-hanger.png") no-repeat center center;
        ...
        div.da-error-wrapper .da-error-pin {
            ...
            z-index: 10;
            position: relative;
            background: url("../imgs/error-pin.png") no-repeat center center
        }
        ...
        <div class="da-content">
            <div class="da-container clearfix">
                <div class="da-error-wrapper">
                    ...
                    <h1 class="da-error-heading">Sorry,���Ժ����� !!! !!!</h1>
                </div>
            </div>
        </div>
    </div>
